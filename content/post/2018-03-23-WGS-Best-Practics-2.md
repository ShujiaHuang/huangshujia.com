...
![VQSR基本原理](http://image.fungenomics.com/vqsr_method.png)
...
![我只是个切菜的](http://image.fungenomics.com/%E5%88%87%E8%8F%9C%E7%9A%84.png)
...
![QD密度分布](http://image.fungenomics.com/qd_raw.png)
...
![VQSR QD密度分布](http://image.fungenomics.com/qd_vqsr.png)
...
![FS密度分布](http://image.fungenomics.com/fs_raw.png)
...
![VQSR FS密度分布](http://image.fungenomics.com/fs_vqsr.png)
...
![SOR列联表](http://image.fungenomics.com/sor_table.png)
...
![SOR密度分布](http://image.fungenomics.com/sor_raw.png)
...
![VQSR SOR密度分布](http://image.fungenomics.com/sor_vqsr.png)

### RMSMappingQuality（MQ）

MQ这个值是所有比对至该位点上的read的比对质量值的均方根（先平方、再平均、然后开方，如下公式）。

![RMS计算式](http://image.fungenomics.com/rms.png)
...
![MQ密度分布](http://image.fungenomics.com/mq_raw.png)

但是，理性告诉我们还是要看一下VQSR的对比结果（下图）。

![VQSR MQ密度分布](http://image.fungenomics.com/mq_vqsr.png)
...
![VQSR MQ密度分布](http://image.fungenomics.com/mq_vqsr2.png)
...
![Ti和Tv转换关系](http://image.fungenomics.com/ti_tv.png)
