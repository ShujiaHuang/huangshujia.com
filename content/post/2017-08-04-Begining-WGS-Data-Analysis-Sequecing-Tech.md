...
image: http://image.fungenomics.com/coverge.png
categories:
    - 生物信息
    - 基因组学
tags:
...
![HiSeq X 10分布（来源：转化医学网）](http://image.fungenomics.com/01.hiseqX10_distribution.png)                                           
...
![图1. 测序技术发展历程](http://image.fungenomics.com/02.ngs_history.png)
...
![图2. Sanger测序发原理](http://image.fungenomics.com/03.sanger.png)
...
![图3. 测序成本比较（来源：NIH网站）](http://image.fungenomics.com/04.sequencing_cost.png)                                          
...
![图4. illumina测序原理（来源：illumina官网）](http://image.fungenomics.com/05.illumina_1.png)
...
![图5. flowcell（实物 VS 示意图）](http://image.fungenomics.com/06.flowcell.png)
<p align="center"><a>图5. flowcell（实物 VS 示意图）</a></p>     
                                                     
3）桥式PCR扩增与变性

![图6. 桥式PCR扩增（来源：illumina官网）](http://image.fungenomics.com/07.illumina_2.png)
...
![图7. 边合成边测序（来源：illumina官网）](http://image.fungenomics.com/08.illumina_3.png)
...
![novaseq_vs_hiseq](http://image.fungenomics.com/09.novaseq_vs_hiseq.png)
*一次测序的数据总产量的单位Gb，不是计算机字节，而是测序碱基的数目（Giga base）*

![图8. NovaSeq与其他测序仪测序通量的比较（来源：illumina官网）](http://image.fungenomics.com/09.NovaSeq_cost.png)
...
![图9. PacBio SMRT 测序read读长分布（来源：PacBio官网）](http://image.fungenomics.com/10.pacbio_seqlength.png)
...
![图10. PacBio SMRT 测序原理](http://image.fungenomics.com/11.pacbio_smrt.png)
...
![图11. PacBio SMRT 检测甲基化修饰（来源：PacBio官网）](http://image.fungenomics.com/12.pacbio_methy.png)
...
![图12. Oxford Nanopore MinION](http://image.fungenomics.com/13.minION.png)
...
![图13. MinION 测序原理](http://image.fungenomics.com/13.MinION2.png)
...
![cost_compare](http://image.fungenomics.com/14.compare.png)
...
![图14. 全球测序仪数量分布](http://image.fungenomics.com/15.sequencing_map.png)
