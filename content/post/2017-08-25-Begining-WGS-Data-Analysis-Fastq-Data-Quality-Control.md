...
image: http://image.fungenomics.com/wgs_03_cover_small.png
categories:
    - 生物信息
    - 基因组学
tags:
...
![数据质控](http://image.fungenomics.com/wgs_03_cover_small.png)
...
![WGS流程图](http://image.fungenomics.com/wgs03.fig1.png)
...
![序列开头的波动](http://image.fungenomics.com/wgs03.fig2.png)
...
![真理](http://image.fungenomics.com/%E5%A6%88%E8%9B%8B%E8%AF%B4%E7%9A%84%E6%98%AF%E7%9C%9F%E7%90%86.png)
...
![太丑，看不下去](http://image.fungenomics.com/%E6%8D%82%E8%84%B8.png)

在做read质量值分析的时候，FastQC并不单独查看具体某一条read中碱基的质量值，而是将Fastq文件中所有的read数据都综合起来一起分析。下图是一个测序质量非常好的read各位置碱基质量分布图（如下图）。

![好的测序结果](http://image.fungenomics.com/wgs03.fig3.good.png)
...
![差的测序结果](http://image.fungenomics.com/wgs03.fig4.bad.png)
...
![碱基总体质量值分布](http://image.fungenomics.com/wgs03.fig5.quality.png)
...
![碱基含量分布](http://image.fungenomics.com/wgs03.fig6.baserate.png)
...
![GC含量分布](http://image.fungenomics.com/wgs03.fig7.GC_content.png)
...
![N含量分布图](http://image.fungenomics.com/wgs03.fig8.N.png)

N在测序数据中一般是不应该出现的，如果出现则意味着，测序的光学信号无法被清晰分辨，如果这种情况多的话，往往意味着测序系统或者测序试剂的错误。

5）接头序列

![接头序列比较](http://image.fungenomics.com/wgs03.fig9.adapter.png)
...
![read测通的情况](http://image.fungenomics.com/wgs03.fig10.seq_adapter.png)
...
![FastQC](http://image.fungenomics.com/wgs03.fig11.fastqc.png)
...
![FastQC的目录](http://image.fungenomics.com/wgs03.fig12.fastqc.png)
...
![输出目录](http://image.fungenomics.com/wgs03.fig13.fastqc.png)

我们可以直接通过浏览器打开html，就可以看到FastQC给出的所有结果，zip压缩包解压后，从中我们也可以在对应的目录下找到所有的QC图表和Summary数据。

![zip解压目录结构](http://image.fungenomics.com/wgs03.fig14.fastqc_fold.png)
...
![切菜哥](http://image.fungenomics.com/%E5%88%87%E8%8F%9C%E7%9A%84.png)
...
![下载Trimmomatic](http://image.fungenomics.com/wgs03.fig15.Trimmomatic.png)

下载后，直接解压，目录下的trimmomatic-*.jar（我下载的是0.36版本）就是执行程序，可以直接使用java来运行。

![Trimmomatic目录](http://image.fungenomics.com/wgs03.fig16.Trimmomatic.png)
...
![废话也要说](http://image.fungenomics.com/%E5%BA%9F%E8%AF%9D%E8%BF%98%E7%94%A8%E4%BD%A0%E8%AF%B4.png)
